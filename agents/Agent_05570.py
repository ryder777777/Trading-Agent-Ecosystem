"""Agent Agent_05570 — strategy code auto-developed by evolution engine v3.
...
EXIT = {"sl_mode": "fixed", "sl": 0.63, "sl_atr": 2.5, "tp_mode": "close", "rr": 7.2, "trail": 1.5}
FILTERS = [{"op": "c1dir", "p": null}]
RISK = 1.0
COOL = 0