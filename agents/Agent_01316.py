"""Agent Agent_01316 — strategy code auto-developed by evolution engine v3.
...
def entry_signals(c, h, l, o):
    # ENTRY BLOCK: stoch {'p': 21, 'd': 5}
    k,ks=stoch(c,h,l,21,5)
    buy=cross_up(k,ks)
    sell=cross_dn(k,ks)

    return buy, sell

EXIT = {"sl_mode": "fixed", "sl": 0.47, "sl_atr": 0.75, "tp_mode": "close", "rr": 2.3, "trail": 1.5}
FILTERS = []
RISK = 1.0
COOL = 0