"""Agent Agent_00741 — strategy code auto-developed by evolution engine v3.
...
def entry_signals(c, h, l, o):
    # ENTRY BLOCK: boll_mr {'p': 100, 'k': 1.5}
    mid=sma(c,100)
    sd=std(c,100)
    buy=c<mid-1.5*sd
    sell=c>mid+1.5*sd
...
EXIT = {"sl_mode": "fixed", "sl": 0.65, "sl_atr": 2.5, "tp_mode": "close", "rr": 8.5, "trail": 2.0}
FILTERS = []
RISK = 1.0
COOL = 0