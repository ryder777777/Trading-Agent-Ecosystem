"""Agent Agent_01605 — strategy code auto-developed by evolution engine v3.
...
def entry_signals(c, h, l, o):
    # ENTRY BLOCK: stoch {'p': 21, 'd': 3}
    k,ks=stoch(c,h,l,21,3)
    buy=cross_up(k,ks)
    sell=cross_dn(k,ks)

    return buy, sell

EXIT = {"sl_mode": "fixed", "sl": 0.47, "sl_atr": 1.0, "tp_mode": "trail", "rr": 5.8, "trail": 1.0}
FILTERS = []
RISK = 1.0
COOL = 0