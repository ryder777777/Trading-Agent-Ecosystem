"""Agent Agent_50522 — strategy code auto-developed by evolution engine v3.
...
def entry_signals(c, h, l, o):
    # ENTRY BLOCK: stoch {'p': 5, 'd': 3}
    k,ks=stoch(c,h,l,5,3)
    buy=cross_up(k,ks)
    sell=cross_dn(k,ks)

    return buy, sell

EXIT = {"sl_mode": "fixed", "sl": 0.4, "sl_atr": 1.0, "tp_mode": "close", "rr": 5.8, "trail": 2.0}
FILTERS = []
RISK = 1.0
COOL = 0